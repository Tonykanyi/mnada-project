...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/kimaki/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2093a3ffeabb4bebc0f577DB1YBUhXXwVSWwQHVVRaA1JRVgQL', mode: 'build'}); } catch(cjsError) { try { import('file:///home/kimaki/.vscode/extensions/wallabyjs.console-ninja-1.0.369/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2093a3ffeabb4bebc0f577DB1YBUhXXwVSWwQHVVRaA1JRVgQL', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
